...
// http://www.braddye.com/flex_pocsag.html

#ifndef DECODE_PAGER_HPP_
#define DECODE_PAGER_HPP_
...
*/
class DecodePager : public blkSink<IQSampleVector>
{
public:
	DecodePager(IBlock *blkIn) : blkSink(blkIn) {}
	virtual ~DecodePager() {}

	virtual Err process();

	virtual std::string getBlkName() { return "DecodePager"; }
